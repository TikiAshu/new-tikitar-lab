...
@section('content')
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Product Grades</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Product Grades</span>
                            </h3>
                        </div>
            ...
            <div class="modal-content">
                ...
                <form class="form" novalidate="novalidate" id="kt_modal_add_customer_form">
                    ...
                    <div class="modal-header" id="kt_modal_add_customer_header">
                        <!--begin::Modal title-->
                        <h2 class="fw-bolder">Add a Product Grade</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                            ...
                            <div class="fv-row mb-7">
                                <label class="required fs-6 fw-bold mb-2">Grade</label>
                                <input type="text" class="form-control form-control-solid" placeholder="Grade name"
                                    name="grade" required />
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="fw-bolder">Edit Product Grade</h2>
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form class="form" novalidate="novalidate" id="kt_customers_edit_form">
                        ...
                        <div class="fv-row mb-7">
                            <label class="required fs-6 fw-bold mb-2">Grade</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Grade name"
                                id="edit_grade" name="grade" required />
                            <div class="fv-plugins-message-container invalid-feedback" id="grade-error"></div>
                        </div>
    ...
    <div class="modal fade" id="kt_customers_view_modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="fw-bolder">View Product Grade</h2>
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form class="form" novalidate="novalidate" id="kt_customers_view_form">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" class="form-control form-control-solid" id="view_grade"
                                name="view_grade" disabled />
                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $("#kt_datatable_example_1").DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('product-grades.index', $productId) }}",
                columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false,
            ...
            // Delete grade
            $(document).on('click', '[data-kt-action="grade_remove"]', function(e) {
                e.preventDefault();

                const button = $(this);
                const gradeId = button.data('id');
                const gradeName = button.data('name');

                Swal.fire({
                    text: "Are you sure you want to delete " + gradeName + "?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        $.ajax({
                            ...
                            success: function(response) {
                                Swal.fire({
                                    text: "You have deleted " + gradeName + "!",
                                    icon: "success",
                                    buttonsStyling: false,
                        ...
                        Swal.fire({
                            text: gradeName + " was not deleted.",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "Ok, got it!",
                            customClass: {
            ...
            // Handle view grade test specs button click
            $(document).on('click', '.view-grade-test-specs', function() {
                const gradeId = $(this).data('id');
                const productId = $(this).data('product-id');
                window.location.href = '/test-specifications/' + productId + '/grade/' + gradeId;
            });
        });
        ...
        $('#kt_modal_add_customer_form').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('product-grades.store') }}",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
                ...
                success: function(response) {
                    Swal.fire({
                        text: "Product grade has been successfully added!",
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        function editGrade(id) {
            ...
            $.ajax({
                url: "/product-grades/edit/" + id,
                type: "GET",
                dataType: "json",
                success: function(response) {
                    const grade = response;

                    $('#edit_id').val(grade.id);
                    $('#edit_grade').val(grade.grade);
                ...
                error: function(xhr) {
                    Swal.fire({
                        text: "Error loading grade details.",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        function viewGrade(id) {
            $.ajax({
                url: "/product-grades/show/" + id,
                type: "GET",
                dataType: "json",
                success: function(response) {
                    const grade = response;

                    $('#view_id').val(grade.id);
                    $('#view_grade').val(grade.grade);
