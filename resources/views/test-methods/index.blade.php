        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Test Methods</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Test Methods</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Test Methods</span>
                            </h3>
                        </div>
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="Test method title"
                                    name="title" />
                                <div class="fv-plugins-message-container invalid-feedback" id="title-error"></div>
                            </div>
                            <!--end::Input group-->
                        </div>
                        <!--end::Scroll-->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form class="form" novalidate="novalidate" id="kt_customers_view_form">
                        ...
                        <div class="fv-row mb-7">
                            <label class="fs-6 fw-bold mb-2">Title</label>
                            <input type="text" class="form-control form-control-solid" id="view_title"
                                name="view_title" disabled />
                        </div>
...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // Delete test method
            $(document).on('click', '[data-kt-action="test_method_remove"]', function(e) {
                e.preventDefault();

                const button = $(this);
                const testMethodId = button.data('id');
                const testMethodName = button.data('name');

                Swal.fire({
                    text: "Are you sure you want to delete " + testMethodName + "?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        $.ajax({
                            ...
                            success: function(response) {
                                Swal.fire({
                                    text: "You have deleted " + testMethodName + "!",
                                    icon: "success",
                                    buttonsStyling: false,
                            ...
                            error: function(xhr) {
                                Swal.fire({
                                    text: "Error deleting " + testMethodName + ".",
                                    icon: "error",
                                    buttonsStyling: false,
                                    confirmButtonText: "Ok, got it!",
                                    customClass: {
                        ...
                        Swal.fire({
                            text: testMethodName + " was not deleted.",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "Ok, got it!",
                            customClass: {
        ...
        $('#kt_modal_add_customer_form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    Swal.fire({
                        text: "Test method has been successfully added!",
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        function editTestMethod(id) {
            ...
            $.ajax({
                url: "/test-methods/" + id + "/edit",
                type: "GET",
                dataType: "json",
                success: function(response) {
                    const testMethod = response;

                    $('#edit_id').val(testMethod.id);
                    $('#edit_specification_id').val(testMethod.specification_id).trigger('change');
                    $('#edit_title').val(testMethod.title);
                ...
                error: function(xhr) {
                    Swal.fire({
                        text: "Error loading test method details.",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        $('#kt_customers_edit_form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    Swal.fire({
                        text: "Test method has been successfully updated!",
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        $(document).on('click', '.edit-test-method', function() {
            const id = $(this).data('id');
            editTestMethod(id);
        });

        // Function to view test method details
        function viewTestMethod(id) {
            $.ajax({
                url: "/test-methods/" + id,
                type: "GET",
                dataType: "json",
                success: function(response) {
                    ...
                    $('#view_id').val(testMethod.id);
                    $('#view_specification').val(testMethod.specification ? testMethod.specification.specification : 'N/A');
                    $('#view_title').val(testMethod.title);
        ...
        $(document).on('click', '.view-test-method', function() {
            const id = $(this).data('id');
            viewTestMethod(id);
        });
