        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Test Parameters</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Test Parameters</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Test Parameters</span>
                            </h3>
                        </div>
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="Test parameter name"
                                    name="test_parameter" />
                                <div class="fv-plugins-message-container invalid-feedback" id="test_parameter-error"></div>
                            </div>
                            <!--end::Input group-->

                            <!--begin::Input group-->
                            <div class="fv-row mb-7">
                                <label class="fs-6 fw-bold mb-2">Sub Parameter</label>
                                <select class="form-select form-control-solid" data-control="select2" data-placeholder="Select an option" name="sub_parameter">
                                    <option></option>
                                    <option value="0" selected>No</option>
                                    <option value="1">Yes</option>
                                </select>
                                <div class="fv-plugins-message-container invalid-feedback" id="sub_parameter-error"></div>
                            </div>
                            <!--end::Input group-->
                        </div>
                        <!--end::Scroll-->
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form class="form" novalidate="novalidate" id="kt_customers_edit_form">
                        ...
                        <div class="fv-row mb-7">
                            <label class="fs-6 fw-bold mb-2">Test Parameter</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Test parameter name"
                                id="edit_test_parameter" name="test_parameter" />
                            <div class="fv-plugins-message-container invalid-feedback" id="test_parameter-error"></div>
                        </div>

                        <div class="fv-row mb-7">
                            <label class="fs-6 fw-bold mb-2">Sub Parameter</label>
                            <select class="form-select form-control-solid" data-control="select2" data-placeholder="Select an option" id="edit_sub_parameter" name="sub_parameter">
                                <option></option>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form class="form" novalidate="novalidate" id="kt_customers_view_form">
                        ...
                        <div class="fv-row mb-7">
                            <label class="fs-6 fw-bold mb-2">Sub Parameter</label>
                            <input type="text" class="form-control form-control-solid" id="view_sub_parameter"
                                name="view_sub_parameter" disabled />
                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $("#kt_datatable_example_1").DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('test-parameters.index') }}",
                columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false,
                    ...
                    data: 'sub_parameter_text',
                    name: 'sub_parameter_text'
                }, {
                    data: 'actions',
                    name: 'actions',
                    orderable: false,
            ...
            $(document).on('click', '[data-kt-action="test_parameter_remove"]', function(e) {
                e.preventDefault();

                const button = $(this);
                const testParameterId = button.data('id');
                const testParameterName = button.data('name');

                Swal.fire({
                    text: "Are you sure you want to delete " + testParameterName + "?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "/test-parameters/" + testParameterId,
                            type: 'DELETE',
                            data: {
                                "_token": "{{ csrf_token() }}"
                            },
                            success: function(response) {
                                Swal.fire({
                                    text: "You have deleted " + testParameterName + "!",
                                    icon: "success",
                                    buttonsStyling: false,
                            ...
                            error: function(xhr) {
                                Swal.fire({
                                    text: "Error deleting " + testParameterName + ".",
                                    icon: "error",
                                    buttonsStyling: false,
                                    confirmButtonText: "Ok, got it!",
                                    customClass: {
                        ...
                        Swal.fire({
                            text: testParameterName + " was not deleted.",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "Ok, got it!",
                            customClass: {
        ...
        $('#kt_modal_add_customer_form').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('test-parameters.store') }}",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
                ...
                success: function(response) {
                    Swal.fire({
                        text: "Test parameter has been successfully added!",
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        function editTestParameter(id) {
            ...
            $.ajax({
                url: "/test-parameters/" + id + "/edit",
                type: "GET",
                dataType: "json",
                success: function(response) {
                    const testParameter = response;

                    $('#edit_id').val(testParameter.id);
                    $('#edit_specification_id').val(testParameter.specification_id).trigger('change');
                    $('#edit_test_parameter').val(testParameter.test_parameter);
                    $('#edit_sub_parameter').val(testParameter.sub_parameter).trigger('change');
                ...
                error: function(xhr) {
                    Swal.fire({
                        text: "Error loading test parameter details.",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        $('#kt_customers_edit_form').on('submit', function(e) {
            ...
            var formData = new FormData(this);
            var testParameterId = $('#edit_id').val();
            ...
            $.ajax({
                ...
                success: function(response) {
                    Swal.fire({
                        text: "Test parameter has been successfully updated!",
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        $(document).on('click', '.edit-test-parameter', function() {
            const id = $(this).data('id');
            editTestParameter(id);
        });

        // Function to view test parameter details
        function viewTestParameter(id) {
            $.ajax({
                url: "/test-parameters/" + id,
                type: "GET",
                dataType: "json",
                success: function(response) {
                    const testParameter = response;

                    $('#view_id').val(testParameter.id);
                    $('#view_specification').val(testParameter.specification ? testParameter.specification.specification : 'N/A');
                    $('#view_test_parameter').val(testParameter.test_parameter);
                    $('#view_sub_parameter').val(testParameter.sub_parameter == '1' ? 'Yes' : 'No');
        ...
        $(document).on('click', '.view-test-parameter', function() {
            const id = $(this).data('id');
            viewTestParameter(id);
        });
        ...
        // Handle view sub-parameters button click
        $(document).on('click', '.view-sub-parameters', function() {
            const testParameterId = $(this).data('id');
            window.location.href = '/test-sub-parameters/' + testParameterId;
        });

        // Handle add sub-parameters button click
        $(document).on('click', '.add-sub-parameters', function() {
            const testParameterId = $(this).data('id');
            window.location.href = '/test-sub-parameters/' + testParameterId;
        });

        // Handle view requirements button click (for test parameters without sub-parameters)
        $(document).on('click', '.view-requirements', function() {
            const testParameterId = $(this).data('id');
            const testSubParameterId = $(this).data('sub-id') || 0;
            window.location.href = '/test-parameter-requirements/' + testParameterId + '/' + testSubParameterId;
        });
    </script>
@endsection
