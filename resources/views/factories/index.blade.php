        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Factory Locations</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Factory Locations</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Factory Locations</span>
                            </h3>
                        </div>
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                            ...
                            <div class="fv-row mb-7">
                                <label class="required fs-6 fw-bold mb-2">Factory Code</label>
                                <input type="text" class="form-control form-control-solid" placeholder="Factory code"
                                    name="factory_code" required />
                                <div class="fv-plugins-message-container invalid-feedback" id="factory_code-error"></div>
                            </div>
                            <!--end::Input group-->

                            <!--begin::Input group-->
                            <div class="fv-row mb-7">
                                <label class="fs-6 fw-bold mb-2">Factory Location</label>
                                <input type="text" class="form-control form-control-solid" placeholder="Factory location name" name="factory_location" />
                                <div class="fv-plugins-message-container invalid-feedback" id="factory_location-error"></div>
                            </div>
                            <!--end::Input group-->
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form class="form" novalidate="novalidate" id="kt_customers_edit_form">
                        ...
                        <div class="fv-row mb-7">
                            <label class="required fs-6 fw-bold mb-2">Factory Code</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Factory code"
                                id="edit_factory_code" name="factory_code" required />
                            <div class="fv-plugins-message-container invalid-feedback" id="factory_code-error"></div>
                        </div>

                        <div class="fv-row mb-7">
                            <label class="fs-6 fw-bold mb-2">Factory Location</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Factory location name"
                                id="edit_factory_location" name="factory_location" />
                            <div class="fv-plugins-message-container invalid-feedback" id="factory_location-error"></div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form class="form" novalidate="novalidate" id="kt_customers_view_form">
                        ...
                        <div class="fv-row mb-7">
                            <label class="fs-6 fw-bold mb-2">Factory Code</label>
                            <input type="text" class="form-control form-control-solid" id="view_factory_code"
                                name="view_factory_code" disabled />
                        </div>

                        <div class="fv-row mb-7">
                            <label class="fs-6 fw-bold mb-2">Factory Location</label>
                            <input type="text" class="form-control form-control-solid" id="view_factory_location"
                                name="view_factory_location" disabled />
                        </div>
...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '[data-kt-action="factory_remove"]', function(e) {
                e.preventDefault();

                const button = $(this);
                const factoryId = button.data('id');
                const factoryName = button.data('name');

                Swal.fire({
                    text: "Are you sure you want to delete " + factoryName + "?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        $.ajax({
                            ...
                            success: function(response) {
                                Swal.fire({
                                    text: "You have deleted " + factoryName + "!",
                                    icon: "success",
                                    buttonsStyling: false,
                            ...
                            error: function(xhr) {
                                Swal.fire({
                                    text: "Error deleting " + factoryName + ".",
                                    icon: "error",
                                    buttonsStyling: false,
                                    confirmButtonText: "Ok, got it!",
                                    customClass: {
                        ...
                        Swal.fire({
                            text: factoryName + " was not deleted.",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "Ok, got it!",
                            customClass: {
        ...
        $('#kt_modal_add_customer_form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    Swal.fire({
                        text: "Factory location has been successfully added!",
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        function editFactory(id) {
            ...
            $.ajax({
                url: "/factories/" + id + "/edit",
                type: "GET",
                dataType: "json",
                success: function(response) {
                    const factory = response;

                    $('#edit_id').val(factory.id);
                    $('#edit_factory_code').val(factory.factory_code);
                    $('#edit_factory_location').val(factory.factory_location);
                    $('#edit_city').val(factory.city);
                    $('#edit_state').val(factory.state);
                    $('#edit_country').val(factory.country);
                    $('#edit_address').val(factory.address);
                ...
                error: function(xhr) {
                    Swal.fire({
                        text: "Error loading factory location details.",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        $('#kt_customers_edit_form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    Swal.fire({
                        text: "Factory location has been successfully updated!",
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        $(document).on('click', '.edit-factory', function() {
            const id = $(this).data('id');
            editFactory(id);
        });

        // Function to view factory details
        function viewFactory(id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#view_id').val(factory.id);
                    $('#view_factory_code').val(factory.factory_code);
                    $('#view_factory_location').val(factory.factory_location);
                    $('#view_city').val(factory.city);
                    $('#view_state').val(factory.state);
                    $('#view_country').val(factory.country);
                    $('#view_address').val(factory.address);
        ...
        $(document).on('click', '.view-factory', function() {
            const id = $(this).data('id');
            viewFactory(id);
        });
