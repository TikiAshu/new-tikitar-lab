...
@section('content')
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Test Sub-Parameters</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Test Sub-Parameters</span>
                            </h3>
                        </div>
            ...
            <div class="modal-content">
                ...
                <form class="form" novalidate="novalidate" id="kt_modal_add_customer_form">
                    ...
                    <div class="modal-header" id="kt_modal_add_customer_header">
                        <!--begin::Modal title-->
                        <h2 class="fw-bolder">Add a Test Sub-Parameter</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                            ...
                            <div class="fv-row mb-7">
                                <label class="required fs-6 fw-bold mb-2">Parameter</label>
                                <input type="text" class="form-control form-control-solid" placeholder="Sub-parameter name"
                                    name="parameter" required />
                                <div class="fv-plugins-message-container invalid-feedback" id="parameter-error"></div>
                            </div>
                            <!--end::Input group-->
                        </div>
                        <!--end::Scroll-->
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="fw-bolder">Edit Test Sub-Parameter</h2>
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form class="form" novalidate="novalidate" id="kt_customers_edit_form">
                        ...
                        <div class="fv-row mb-7">
                            <label class="required fs-6 fw-bold mb-2">Parameter</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Sub-parameter name"
                                id="edit_parameter" name="parameter" required />
                            <div class="fv-plugins-message-container invalid-feedback" id="parameter-error"></div>
                        </div>
    ...
    <div class="modal fade" id="kt_customers_view_modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="fw-bolder">View Test Sub-Parameter</h2>
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form class="form" novalidate="novalidate" id="kt_customers_view_form">
                        ...
                        <div class="fv-row mb-7">
                            <label class="fs-6 fw-bold mb-2">Parameter</label>
                            <input type="text" class="form-control form-control-solid" id="view_parameter"
                                name="view_parameter" disabled />
                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $("#kt_datatable_example_1").DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('test-sub-parameters.index', $testParameterId) }}",
                columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false,
            ...
            $(document).on('click', '[data-kt-action="sub_parameter_remove"]', function(e) {
                e.preventDefault();

                const button = $(this);
                const subParameterId = button.data('id');
                const subParameterName = button.data('name');

                Swal.fire({
                    text: "Are you sure you want to delete " + subParameterName + "?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "/test-sub-parameters/" + subParameterId,
                            type: 'DELETE',
                            data: {
                                "_token": "{{ csrf_token() }}"
                            },
                            success: function(response) {
                                Swal.fire({
                                    text: "You have deleted " + subParameterName + "!",
                                    icon: "success",
                                    buttonsStyling: false,
                            ...
                            error: function(xhr) {
                                Swal.fire({
                                    text: "Error deleting " + subParameterName + ".",
                                    icon: "error",
                                    buttonsStyling: false,
                                    confirmButtonText: "Ok, got it!",
                                    customClass: {
                        ...
                        Swal.fire({
                            text: subParameterName + " was not deleted.",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "Ok, got it!",
                            customClass: {
            ...
            // Handle view sub-requirements button click
            $(document).on('click', '.view-sub-requirements', function() {
                const testParameterId = $(this).data('id');
                const testSubParameterId = $(this).data('sub-id');
        ...
        $('#kt_modal_add_customer_form').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('test-sub-parameters.store') }}",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
                ...
                success: function(response) {
                    Swal.fire({
                        text: "Test sub-parameter has been successfully added!",
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        function editSubParameter(id) {
            ...
            $.ajax({
                url: "/test-sub-parameters/edit/" + id,
                type: "GET",
                dataType: "json",
                success: function(response) {
                    const subParameter = response;

                    $('#edit_id').val(subParameter.id);
                    $('#edit_parameter').val(subParameter.parameter);
                ...
                error: function(xhr) {
                    Swal.fire({
                        text: "Error loading sub-parameter details.",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        $('#kt_customers_edit_form').on('submit', function(e) {
            ...
            var formData = new FormData(this);
            var subParameterId = $('#edit_id').val();
            ...
            $.ajax({
                ...
                success: function(response) {
                    Swal.fire({
                        text: "Test sub-parameter has been successfully updated!",
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        $(document).on('click', '.edit-sub-parameter', function() {
            const id = $(this).data('id');
            editSubParameter(id);
        });

        // Function to view sub-parameter details
        function viewSubParameter(id) {
            $.ajax({
                url: "/test-sub-parameters/show/" + id,
                type: "GET",
                dataType: "json",
                success: function(response) {
                    const subParameter = response;

                    $('#view_id').val(subParameter.id);
                    $('#view_parameter').val(subParameter.parameter);
        ...
        $(document).on('click', '.view-sub-parameter', function() {
            const id = $(this).data('id');
            viewSubParameter(id);
        });
