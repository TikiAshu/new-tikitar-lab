        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Lab Locations</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Lab Locations</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Lab Locations</span>
                            </h3>
                        </div>
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                            ...
                            <div class="fv-row mb-7">
                                <label class="required fs-6 fw-bold mb-2">Lab Location</label>
                                <input type="text" class="form-control form-control-solid" placeholder="Lab location name"
                                    name="lab_location" required />
                                <div class="fv-plugins-message-container invalid-feedback" id="lab_location-error"></div>
                            </div>
                            <!--end::Input group-->

                            <!--begin::Input group-->
                            <div class="fv-row mb-7">
                                <label class="required fs-6 fw-bold mb-2">Lab Code</label>
                                <input type="text" class="form-control form-control-solid" placeholder="Lab code" name="lab_code" required />
                                <div class="fv-plugins-message-container invalid-feedback" id="lab_code-error"></div>
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="fv-plugins-message-container invalid-feedback" id="phone-error"></div>
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="Fax number" name="fax" required />
                                <div class="fv-plugins-message-container invalid-feedback" id="fax-error"></div>
                            </div>
                            <!--end::Input group-->
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form class="form" novalidate="novalidate" id="kt_customers_edit_form">
                        ...
                        <div class="fv-row mb-7">
                            <label class="required fs-6 fw-bold mb-2">Lab Location</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Lab location name"
                                id="edit_lab_location" name="lab_location" required />
                            <div class="fv-plugins-message-container invalid-feedback" id="lab_location-error"></div>
                        </div>

                        <div class="fv-row mb-7">
                            <label class="required fs-6 fw-bold mb-2">Lab Code</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Lab code"
                                id="edit_lab_code" name="lab_code" required />
                            <div class="fv-plugins-message-container invalid-feedback" id="lab_code-error"></div>
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            <label class="fs-6 fw-bold mb-2">Address</label>
                            <textarea class="form-control form-control-solid" rows="3" id="edit_address" name="address"
                                placeholder="Full address"></textarea>
                            <div class="fv-plugins-message-container invalid-feedback" id="address-error"></div>
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            <label class="required fs-6 fw-bold mb-2">Fax</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Fax number"
                                id="edit_fax" name="fax" required />
                            <div class="fv-plugins-message-container invalid-feedback" id="fax-error"></div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form class="form" novalidate="novalidate" id="kt_customers_view_form">
                        ...
                        <div class="fv-row mb-7">
                            <label class="fs-6 fw-bold mb-2">Lab Location</label>
                            <input type="text" class="form-control form-control-solid" id="view_lab_location"
                                name="view_lab_location" disabled />
                        </div>

                        <div class="fv-row mb-7">
                            <label class="fs-6 fw-bold mb-2">Lab Code</label>
                            <input type="text" class="form-control form-control-solid" id="view_lab_code"
                                name="view_lab_code" disabled />
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            <label class="fs-6 fw-bold mb-2">Address</label>
                            <textarea class="form-control form-control-solid" id="view_address" name="view_address" disabled></textarea>
                        </div>

                        <div class="fv-row mb-7">
                            <label class="fs-6 fw-bold mb-2">Phone</label>
                            <input type="text" class="form-control form-control-solid" id="view_phone"
                                name="view_phone" disabled />
                        </div>

                        <div class="fv-row mb-7">
                            <label class="fs-6 fw-bold mb-2">Fax</label>
                            <input type="text" class="form-control form-control-solid" id="view_fax"
                                name="view_fax" disabled />
                        </div>
...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // Delete lab location
            $(document).on('click', '[data-kt-action="lab_remove"]', function(e) {
                e.preventDefault();

                const button = $(this);
                const labId = button.data('id');
                const labName = button.data('name');

                Swal.fire({
                    text: "Are you sure you want to delete " + labName + "?",
                    icon: "warning",
        ...
        $('#kt_modal_add_customer_form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    Swal.fire({
                        text: "Lab location has been successfully added!",
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        function editLab(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#edit_id').val(lab.id);
                    $('#edit_lab_location').val(lab.lab_location);
                    $('#edit_lab_code').val(lab.lab_code);
                    $('#edit_city').val(lab.city);
                    $('#edit_state').val(lab.state);
                    $('#edit_country').val(lab.country);
                    $('#edit_address').val(lab.address);
                    $('#edit_phone').val(lab.phone);
                    $('#edit_fax').val(lab.fax);
                    $('#edit_email').val(lab.email);
                ...
                error: function(xhr) {
                    Swal.fire({
                        text: "Error loading lab location details.",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        $('#kt_customers_edit_form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    Swal.fire({
                        text: "Lab location has been successfully updated!",
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
        ...
        function viewLab(id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#view_id').val(lab.id);
                    $('#view_lab_location').val(lab.lab_location);
                    $('#view_lab_code').val(lab.lab_code);
                    $('#view_city').val(lab.city);
                    $('#view_state').val(lab.state);
                    $('#view_country').val(lab.country);
                    $('#view_address').val(lab.address);
                    $('#view_phone').val(lab.phone);
                    $('#view_fax').val(lab.fax);
                    $('#view_email').val(lab.email);
